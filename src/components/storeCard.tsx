...
const ITEMS = [
	...
	},
	{
		id: 2,
		description:
			'Adds +5 points per click but increases your chance of losing by 2%.',
		price: 15,
	...
	},
	{
		id: 3,
		description:
			'Adds +20 points per click but increases your chance of losing by 5%.',
		price: 50,
		pointsPerClickBoost: 20,
		riskBoost: 0.05,
	},
	{
		id: 4,
		...
		<div className="flex flex-col p-2 pt-4 gap-4 rounded-lg bg-background min-w-[200px] justify-between">
			<div className="flex justify-between text-xs font-bold">
				<div className="rounded-full bg-secondary w-8 h-8 pt-2">
					<span>
						{item.pointsPerClickBoost > 0 ? '+' : null}
						{item.pointsPerClickBoost}
					</span>
				</div>
				<div className="rounded-full bg-secondary w-8 h-8 pt-2">
					<span>
